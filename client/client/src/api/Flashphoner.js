...
//                me.calls.remove(call.callId);
            ...
            notifyBugReport: function (filename) {
                me.invokeListener(WCSEvent.OnBugReportEvent, [
                    {filename: filename}
                ]);
            },
            ...
            notifyRecordComplete: function (recordReport) {
                me.invokeListener(WCSEvent.OnRecordCompleteEvent, [
                    recordReport
                ]);
            },
    ...
    connect: function (connection, urlServer) {
        var me = this;
    ...
    sendXcapRequest: function (xcapUrl) {
        xcapUrl = xcapUrl || this.configuration.xcapUrl;
        if (xcapUrl) {
