 ...
 * C2CRtmpClient is a main class of Flashphoner server side application responsible for RTMP-SIP bridge.<br/>
 * See more info in {@link com.flashphoner.sdk.rtmp.IRtmpClient} and in {@link AbstractRtmpClient} class.
 */
public class C2CRtmpClient extends AbstractRtmpClient {


    private String callee;

    /**
     * Create new C2CRtmpClient instance, see AbstractRtmpClient constructor
     *
     * @param login
     * @param pwd
     * @param client
     ...
     * @param mode
     */
    public C2CRtmpClient(String login, String pwd, IClient client, String sipProviderAddress, int sipProviderPort, String visibleName, boolean regRequired, String appName, String mode) {
        super(login, pwd, client, sipProviderAddress, sipProviderPort, visibleName, regRequired, appName, mode);
    }

    public C2CRtmpClient(String login, String pwd, IClient client, String sipProviderAddress, int sipProviderPort, String visibleName, boolean regRequired, String appName, String mode, Integer width, Integer height) {
        super(login, pwd, client, sipProviderAddress, sipProviderPort, visibleName, regRequired, appName, mode, width, height);
    }

    public C2CRtmpClient(String login, String pwd, IClient client, String sipProviderAddress, int sipProviderPort, String visibleName, boolean regRequired, String appName, String mode, Integer width, Integer height, String supportedResolutions) {
    ...
    public C2CRtmpClient(String login, String authenticationName, String pwd, IClient client, String sipProviderAddress, int sipProviderPort, String visibleName, boolean regRequired, String appName, String mode, Integer width, Integer height, String supportedResolutions) {
        super(login, pwd, client, sipProviderAddress, sipProviderPort, visibleName, regRequired, appName, mode, width, height, supportedResolutions);
     ...
     * @param mode
     */
    public C2CRtmpClient(String login, String pwd, IClient client, boolean regRequired, String appName, String mode) {
     ...
     * @param mode
     */
    public C2CRtmpClient(final String login, final String pwd,
     ...
     * @param mode
     */
    public C2CRtmpClient(final String login, final String pwd, final String appName, String mode) {
     ...
     */
    public C2CRtmpClient(String login, String authenticationName, String pwd, IClient client, String sipProviderAddress, int sipProviderPort, String visibleName, boolean regRequired, String appName, String mode) {
     ...
     * @param iClient
     */
    public C2CRtmpClient(RtmpClientConfig rtmpClientConfig, IClient iClient) {
    ...
    public void registered(SipHeader sipHeader) {
        Logger.logger.info(4, "C2CRtmpClient.registered()");
    ...
    public void notifyBalance(String balance, SipHeader sipHeader) {
        Logger.logger.info(4, "C2CRtmpClient.notifyBalance()");
    ...
    public void incommingCall(ISoftphoneCall call) {
        Logger.logger.info(4, "C2CRtmpClient.incommingCall() " + call.getId());
    ...
    public void ring(ISoftphoneCall call, SipHeader sipHeader) {
        Logger.logger.info(4, "C2CRtmpClient.ring() " + call.getId());
        if (sipHeader == null) {
    ...
    public void ringing(ISoftphoneCall call, SipHeader sipHeader) {
        Logger.logger.info(4, "C2CRtmpClient.ringing() " + call.getId());
    }
    ...
    public void sessionProgress(ISoftphoneCall call, SipHeader sipHeader) {
        Logger.logger.info(4, "C2CRtmpClient.sessionProgress()");
        if (sipHeader == null) {
            sipHeader = new SipHeader();
        }
    ...
    public void talk(ISoftphoneCall call, SipHeader sipHeader) {
        Logger.logger.info(4, "C2CRtmpClient.talk() " + call.getId());
        if (sipHeader == null) {
            sipHeader = new SipHeader();
        }
    ...
    public void notifyHold(ISoftphoneCall call, SipHeader sipHeader) {
        Logger.logger.info(4, "C2CRtmpClient.notifyHold() " + call.getId());
        if (sipHeader == null) {
            sipHeader = new SipHeader();
        }
    ...
    public void callbackHold(ISoftphoneCall call, Boolean isHold) {
        Logger.logger.info(4, "C2CRtmpClient.callbackHold()");
    ...
    public void finish(ISoftphoneCall call, SipHeader sipHeader) {
        Logger.logger.info(4, "C2CRtmpClient.finish() " + call.getId());
        if (sipHeader == null) {
            sipHeader = new SipHeader();
        }
    ...
    public void busy(ISoftphoneCall call, SipHeader sipHeader) {
        Logger.logger.info(4, "C2CRtmpClient.busy() " + call.getId());
        if (sipHeader == null) {
            sipHeader = new SipHeader();
        }
    ...
    public ISoftphoneCall call(final String caller, final String callee, final String visibleName, final Boolean isVideoCall) throws SoftphoneException, LicenseRestictionException {
        Logger.logger.info(4, "C2CRtmpClient.call() " + callee);
    ...
    public void answer(final String callId, final Boolean isVideoCall) throws SoftphoneException {
        Logger.logger.info(4, "C2CRtmpClient.answer() " + callId);
    ...
    public void updateCallToVideo(final String callId) throws SoftphoneException {
        Logger.logger.info(4, "C2CRtmpClient.updateCallToVideo() " + callId);
    ...
    public void hangup(final String callId) throws SoftphoneException {
        Logger.logger.info(4, "C2CRtmpClient.hangup() " + callId);
    ...
    public void transfer(final String callId, final String callee) throws SoftphoneException {
        Logger.logger.info(4, "C2CRtmpClient.transfer() " + callId);
    ...
    public void hold(final String callId, final Boolean isHold) throws SoftphoneException {
        Logger.logger.info(4, "C2CRtmpClient.hold() " + callId + "; holding - " + isHold);
    ...
    public void sendDtmf(final String callId, final String dtmf) throws SoftphoneException {
        Logger.logger.info(4, "C2CRtmpClient.sendDtmf() " + dtmf);
    ...
    public void fail(String errorCode, SipHeader sipHeader) {
        Logger.logger.info(4, "C2CRtmpClient.fail() " + errorCode);
        if (sipHeader == null) {
            sipHeader = new SipHeader();
        }
        if (getClient() != null) {
    ...
    public void notifyVideoFormat(ISoftphoneCall call) {
        Logger.logger.info(4, "C2CRtmpClient.notifyVideoFormat() " + call.getId());
        if (getClient() != null) {
    ...
    public void notifyAudioCodec(String audioCodec) {
        Logger.logger.info(4, "C2CRtmpClient.notifyAudioCodec() " + audioCodec);
